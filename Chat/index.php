...
if (isset($_POST["submit"])) {
 ...
 30));
   $update_status_command = "UPDATE `users_online` SET status = 'online' WHERE first_name ='$username' AND last_name = '$users_last_name'";
...
<body style="background-image: url('Logo1.jpg'); background-repeat: no-repeat; background-position: center center; background-size: auto;">

<!--<img src="Logo1.jpg" class="logo" style="height: 10em; float: left;" />-->
